...
## [13.0.0-alpha.9](https://github.com/sjjf/tokei/compare/v13.0.0-alpha.8...v13.0.0-alpha.9) - 2025-02-01

### Other

- Fix CRLF or mixed CRLF/LF line terminations in Markdown files ([#1219](https://github.com/sjjf/tokei/pull/1219))
- Fix a minor typo in CLI help text ([#1217](https://github.com/sjjf/tokei/pull/1217))
- Fix a missing space in CLI help text ([#1218](https://github.com/sjjf/tokei/pull/1218))
- Relax lifetime constraints in language::embedding ([#1225](https://github.com/sjjf/tokei/pull/1225))
